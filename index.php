...
<body >
	...
	<div id="header">
       <br>
       <h1 style=" font-weight:bold;font-size:60px;text-shadow: 2px 2px black;">&nbsp;&nbsp;&nbsp;&nbsp; Sparks Foundation Banking System </h1> <br><br>
       <h2 style=" text-shadow: 2px 2px red;color:red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; By G.K.Sushma </h2>
    </div>
	<br>
	<br>
        <div id="section">
